...
RSpec.describe "Recipe index page", type: :feature do
    ...
    let!(:recipe1) { Recipe.create!(user: user, name: "Chicken and Rice", preparation_time: 30, cooking_time: 60, description: "A classic dish that is easy to make.", public: true) }
    let!(:recipe2) { Recipe.create!(user: user, name: "Spaghetti Bolognese", preparation_time: 20, cooking_time: 40, description: "A family favorite.", public: true) }
