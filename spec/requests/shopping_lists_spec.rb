...
RSpec.describe "ShoppingLists", type: :request do
  ...
  let!(:recipe) { Recipe.create!(user: user, name: "Chicken and Rice", preparation_time: 30, cooking_time: 60, description: "A classic dish that is easy to make.", public: true) }
