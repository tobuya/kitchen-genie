...
# Create some foods
food1 = Food.create!(user_id: user1.id, name: "Chicken", measurement_unit: "grams", price: 100, quantity: 500)
food2 = Food.create!(user_id: user1.id, name: "Rice", measurement_unit: "kilograms", price: 50, quantity: 1000)
food3 = Food.create!(user_id: user2.id, name: "Beef", measurement_unit: "pieces", price: 150, quantity: 750)
